...
class plugin_info_save_core_plugin_files
	...
	function __construct()
		...
		$this->data=array(
			...
			"category"=>"System",
			"marketing"=>"This Plugin will Save your Jomres Core Plugins files for later use if you did not need it now and after your Jomres Subscription has expires. After this plugin is installed; All you need to do is just hit the blue Install or Reinstall button under the Add/reinstall/upgrade plugin column.",
			"version"=>"1.2",
