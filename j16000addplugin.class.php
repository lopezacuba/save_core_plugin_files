...
class j16000addplugin
{
    ...
    if (!is_dir(JOMRESCONFIG_ABSOLUTE_PATH.JOMRES_ROOT_DIRECTORY.JRDS.'saved_plugins')) {
			if (!mkdir(JOMRESCONFIG_ABSOLUTE_PATH.JOMRES_ROOT_DIRECTORY.JRDS.'saved_plugins')) {
				$error_messsage[ 'ERROR' ] = "Couldn't make the folder ".JOMRESCONFIG_ABSOLUTE_PATH.JOMRES_ROOT_DIRECTORY.JRDS.'saved_plugins'.' so quitting.';
				echo $error_messsage[ 'ERROR' ];
    ...
    $savedpluginsDirPath = JOMRESCONFIG_ABSOLUTE_PATH.JOMRES_ROOT_DIRECTORY.JRDS.'saved_plugins'.JRDS;
        ...
        $oldfilename = $savedpluginsDirPath.$pluginName.'.zip';
